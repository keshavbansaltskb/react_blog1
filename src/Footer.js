        ...
        <div style={{}}>
                <div className="row" style={{backgroundColor:"black",padding:"30px",marginTop:"60px"}}>
                    ...
                    <div className="col-sm-4">
                        ...
                        <label id="footertext">TERM</label><br/>
                        <label id="footertext">CONTACT</label><br/>
                    </div>
                    <div className="col-sm-4">
                        <label  id="footertext">CONTACT:mr.ddb01@gmail.com<br/> Mukta Prasad Colony, Bikaner, <br/> Rajasthan (9358391857)
                        </label>
                    </div>
                
                <br/><br/>
               
                    <label id="footertext">Copyright : keshavbansal9358@gmail.com
                    <br/>
                    KESHAV BANSAL
                    </label>
                </div>
